...
const Ticket = ({ order, order_status_list, order_product, href }) => {
    ...
    const handleClick = () => {
        ...
        lastOrderStatusId === 1 && actions.postOrderStatus(2, _id)
    }
    ...
    return (
        <StyledCard to={href} onClick={handleClick} laststatus={2} listorderstatus={getLastOrderStatusList(order_status_list)}>
